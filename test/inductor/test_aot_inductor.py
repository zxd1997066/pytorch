...
class AOTInductorTestsTemplate:
    ...
    def test_constant_original_fqn(self):
        ...
        loaded_module = AOTInductorModelRunner.load_module(self.device, so_path)
        self.assertEqual(
            expected_fqn, loaded_module.get_constant_names_to_original_fqns()
        )
