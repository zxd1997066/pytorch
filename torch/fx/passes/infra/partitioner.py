...
class DependencyViewer:
    def __init__(self, graph_module: GraphModule):
        ...
        self.downstreams = defaultdict(set)
    ...
    def downstreams_of(self, node: Node) -> List[Node]:
        return self.downstreams[node]

    def upstreams_of(self, node: Node) -> List[Node]:
...
class CapabilityBasedPartitioner:
    ...
    def __init__(self,
        ...
        self.dependency_viewer = DependencyViewer(graph_module)
    ...
    def propose_partitions(self) -> List[Partition]:
        ...
        def merge_single_node(node: Node, id: Optional[int]):
            def _update_partition_map(node: Node):
